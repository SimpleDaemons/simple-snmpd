...
docker-run:
	docker run -d --name $(PROJECT_NAME)-$(VERSION) -p 161:161 $(PROJECT_NAME):$(VERSION)
...
ifeq ($(PLATFORM),macos)
	...
	@if exist scripts\build-windows.bat ( \
		...
		echo "  sc create SimpleSNMPDaemon binPath= \"$(INSTALL_PREFIX)\\bin\\$(PROJECT_NAME).exe\""; \
		echo "  sc start SimpleSNMPDaemon"; \
	)
endif
...
ifeq ($(PLATFORM),macos)
	...
	@sc query SimpleSNMPDaemon
endif

# Help - Main help (most common targets)
help:
	@echo "Simple SNMP Daemon - A lightweight and secure SNMP monitoring daemon - Main Help"
	@echo "=================================="
	@echo ""
...
help-all:
	@echo "Simple SNMP Daemon - A lightweight and secure SNMP monitoring daemon - All Available Targets"
	@echo "=============================================="
	@echo ""
	@echo "Essential targets:"
	@echo "  all              - Build the project (default)"
...
ifeq ($(PLATFORM),macos)
	...
	@sc config SimpleSNMPDaemon start= auto
endif
...
ifeq ($(PLATFORM),macos)
	...
	@sc config SimpleSNMPDaemon start= disabled
endif
...
ifeq ($(PLATFORM),macos)
	...
	@sc query SimpleSNMPDaemon >nul 2>&1 && ( \
		sc stop SimpleSNMPDaemon; \
		sc delete SimpleSNMPDaemon; \
		echo "Service uninstalled successfully"; \
	) || echo "Service not found"
endif
